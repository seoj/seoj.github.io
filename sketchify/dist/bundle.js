...
exports.sketchify = void 0;
function sketchify(inputImageData) {
    const outputImageData = new ImageData(new Uint8ClampedArray(inputImageData.width * inputImageData.height * 4), inputImageData.width, inputImageData.height);
...
function drawOutputImage() {
    outputCtx.putImageData(functions_1.sketchify(inputCtx.getImageData(0, 0, inputCanvas.width, inputCanvas.height)), 0, 0);
}
